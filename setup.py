...
def setup(project_name='petclinic-rest',
          service_list={'petclinic-rest-system': '8080','petclinic-rest-owner': '8080', 'petclinic-rest-pet': '8080','petclinic-rest-vet': '8080','petclinic-rest-visit': '8080'}
          , region='us-west-2'):
    ecr_client = boto3.client('ecr')
    ...
    for service in service_list:
        ...
        if service == 'petclinic-rest-system':
...
def cleanup(project_name='petclinic-rest',
            service_list={'petclinic-rest-system': '8080','petclinic-rest-owner': '8080', 'petclinic-rest-pet': '8080','petclinic-rest-vet': '8080','petclinic-rest-visit': '8080'}, region='us-west-2'):
    ecr_client = boto3.client('ecr')
    ecs_client = boto3.client('ecs')
...
def main():
    ...
    parser.add_argument('-s', '--service_list', required=False,
                        default={'petclinic-rest-system': '8080','petclinic-rest-owner': '8080', 'petclinic-rest-pet': '8080','petclinic-rest-vet': '8080','petclinic-rest-visit': '8080'},
                        help="Service list. Default {'petclinic-rest-owner' : '8080',"
                             "'petclinic-rest-pet' : '8080','petclinic-rest-system' : '8080',"
                             "'petclinic-rest-vet' : '8080','petclinic-rest-visit' : '8080'}")
